...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_INVENSENSE_MPU6050_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32_COUNTER_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32_QDEC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 51);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32F407_BALANCE_CAR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32F407_BALANCE_CAR_STM32F407XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32F407XE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_SUPPORTS_CAPTURE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_TIMER_STM32, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DMA_XILINX_ADMA_SG_BUFFER_COUNT, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DMA_XILINX_ADMA_DESC_POOL_ALIGNMENT, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QDEC_STM32, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPU6050, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPU6050_TRIGGER_NONE, 1);

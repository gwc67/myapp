...
// static struct uart_dma_t s_uart2_st;
...
int uart_board_init(void)
{
    ...
    // static const struct uart_dma_cfg_t uart2_dma_cfg_st = {
    ...
    // };
    // int ret = uart_dma_init_rt(&s_uart2_st, &uart2_dma_cfg_st, g_ut2_rx_ring_pst,g_ut2_tx_ring_pst);
